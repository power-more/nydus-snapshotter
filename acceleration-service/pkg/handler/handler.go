...
func (handler *LocalHandler) Convert(ctx context.Context, ref string, manifestDigest digest.Digest, layerDigest digest.Digest, blob *os.File, isLastLayer bool) error {
	return handler.cvt.Dispatch(ctx, ref, manifestDigest, layerDigest, blob, isLastLayer)
}
